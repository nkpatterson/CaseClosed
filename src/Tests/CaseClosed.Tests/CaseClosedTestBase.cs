...
{
    public abstract class CaseClosedTestBase : AbpIntegratedTestBase
    {
        protected CaseClosedTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<CaseClosedApplicationModule>();
            modules.Add<CaseClosedDataModule>();
        }

        public void UsingDbContext(Action<CaseClosedDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<CaseClosedDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<CaseClosedDbContext, T> func)
        {
            T result;
